...
$$\hat {lwage} = \hat \beta_0 - .124 \,belavg + .035 \,abvavg + other \,factor$$ A woman with below average looks earns about 12.4% less than an otherwise comparable average-looking woman.As was the case for men, the estimate on abvavg is much smaller in magnitude and not statistically different from zero.
